 ...
 */
@Entity
public class Camera implements Serializable, Equipment{
    ...
    public static class Builder{
        ...
        public Builder camera(Camera cam){
            id = cam.getId();
            name = cam.getName();
            code = cam.getCode();
            costPrice = cam.getCostPrice();
            return this;
        }
        public Camera build(){
    ...
    public String toString() {
        return "Camera{" + "id=" + id + ", name=" + name + ", code=" + code + '}';
    }
